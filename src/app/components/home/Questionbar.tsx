...
const Questionbar = ({ onSubmit }: { onSubmit: (question: string) => void }) => {
  ...
  return (
    <div className="my-4 flex w-[100%] flex-row items-center rounded-full bg-white bg-opacity-10">
      <div className="mx-1 flex h-[40px] items-center rounded-full border-opacity-20 bg-white bg-opacity-10 px-5 font-albert font-normal text-white">{activeHive}</div>
